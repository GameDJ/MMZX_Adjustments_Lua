...
--OX, ZX and X: Can perform a small double jump (or full double jump for overdrive OX)
--
--Known issues:
...
while true do
	...
	double_jump(true, true, true) --Gives double jump to OX, ZX, X (set booleans to toggle for each)
